...
#+ATTR_REVEAL: :frag (appear)
   *Definition:* A typed ‘module, context, telescope, package former, record, typeclass’
   ...
   ~name ∶ type := optional-definition~.

#+ATTR_REVEAL: :frag (appear)
   Without types, we obtain essentially [[https://en.wikipedia.org/wiki/JSON][JSON Objects]].
...
#+BEGIN_SRC haskell
Carrier′  : Monoid-Σ → Set   -- boilerplate
Carrier′ = proj₁
 #+END_SRC
...
#+ATTR_REVEAL: :frag (grow)
#+begin_quote
 This suggests a hidden polymorphism!
#+end_quote
...
+ e.g., ~Monoid.Semigroup.Magma.Carrier M~.
+ ⇒ /flatten hierarchies!/
...
We have a prototype (•̀ᴗ•́)و
# REVEAL_HTML: <iframe width="420" height="315" src="https://www.youtube.com/embed/NYOOF9xKBz8" frameborder="0" allowfullscreen></iframe>

#+REVEAL_HTML: <iframe width="420" height="315" src="https://www.youtube.com/embed/NYOOF9xKBz8?version=3&autoplay=1&mute=1&loop=1" frameborder="0" allowfullscreen></iframe>
