...
*Prerequisite of the reader:* Going forward, it is assumed that the reader is
comfortable programming with Haskell, and the associated menagerie of Category
Theory concepts that are usually present in the guise of Functional Programming.
In particular, this includes ‘practical’ notions such as typeclasses and
instance search, as well as ‘theoretical’ notions such categorial limits and
colimits, lattices ---a kind of category with products--- and monoids
---possibly in arbitrary monoidal categories, as is the case with monads.
...
same by definition ---the notion of equality wass defined in
