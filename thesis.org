...
- you're missing a "lessons learned" section where you summarize the problems
...
focus on readability (§ ref:sec:examples:readability, ref:sec:examples:renaming)
and on mixing-in features to an existing module (§ ref:sec:examples:IsX,
...
and is covered later in §ref:sec:absurd_pattern.
...
easily supporting the gls:little-theories cite:little_theories method and making
...
magma.
 ...
 structures can be constructed by transport along views cite:little_theories: A
...
*** ⟨3⟩ Constructor Functions with ~new~
