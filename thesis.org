...
*** Summary of Sample Variationals Provided With The System :ignore:
 ...
 have implemented a few notable ones, as described in Table
 ref:tbl:variationals-summary. The implementations, in the user manual, are
 discussed along with the associated Lisp code and use cases.
 #+latex: \end{tcolorbox}
 ...
 #+caption: Summary of Sample Variationals Provided With The System
   ...
   \noindent Below, in Table ref:tbl:meta-primitives, are the *five
