...
In the dependently-typed setting, one also obtains so-called ‘canonical structures’ cite:coq_canonical,
...
some of the use cases in ‘the Maude book’ cite:maude using a core
