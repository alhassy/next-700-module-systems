...
* TODO COMMENT The First Choice: What is the target setting?
** What setting are we targeting, why? :ignore:

Programming language communities whose language has an impressive type system,
such as Haskell's, have proverbs such as “if it typechecks, ship it!” Such a
...
*** Agda --“Haskell on steroids”
  ...
  programming with the ability to ‘escape under the hood’ and write Haskell code.
...
*** Coq ---“The standard proof assistant”
  ...
  *Coq cite:coq_implementation,coq_cat_experiences:* Unquestionably one of, if not,
  ...
  paste” contents of modules using the ~include~ keyword. Consequently it provides
...
*** COMMENT $\text{F}^*$ ---“the immature adult”
...
*** TODO COMMENT Notable Mention
   ...
   support for named contexts in the form of ‘locales’ cite:locales, isabelle_locales;
