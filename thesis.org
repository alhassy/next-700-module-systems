...
* COMMENT Introduction ---The Thesis’ “Story”
  :PROPERTIES:
...
The sections below explore our primary observation.
Section 1 demonstrates the variety of languages present in a
single system which are conflated in a DTL, section 2 discusses that such
conflation should by necessity apply to notions of packaging, section 3
contains contributed work to ensure that happens. Finally, section 4
concludes by outlining the remainder of the thesis.
...
writes ~if (cond) clause₁ else clause₂~ for statements but must use the notation
~cond?term₁:term₂~ for values. Hence, there are value and statement languages.
...
The methods currently utilised are ad hoc, e.g., “dump the contents of
packages into a new über package”. What about when the packages contain
conflicting names? “Make an über package with field names for each package's
contents”. What about viewing the new über package as a hierarchy of its
packages? “Make conversion methods between the two representations.” This
...
setting of DTLs, records in the form of nested Σ-types tend to have tremendously
...
support? “Use a pre-processor, approximate packaging at a different language
level, or simply settle with what you have.”
...
is to /use a dependently-typed language to implement/ /the ‘missing’ module
...
| [2])                                                                                           |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| LaTeX                                                                                          | Warning:                                                                    | Empty                                          | bibliography  | on                     | input       | line               | 255         |                    |                  |          |         |     |
| [3]                                                                                            | (./thesis.aux)                                                              |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
...
| {page.21}                                                                                      | has                                                                         | been                                           | referenced    | but                    | does        | not                | exist,      | replaced           |               by | a        | fixed   | one |
| pdfTeX                                                                                         | warning                                                                     | (dest):                                        | name{page.15} | has                    | been        | referenced         | but         | does               |              not | exist,   | re      |     |
| placed                                                                                         | by                                                                          | a                                              | fixed         | one                    |             |                    |             |                    |                  |          |         |     |
| pdfTeX                                                                                         | warning                                                                     | (dest):                                        | name{page.17} | has                    | been        | referenced         | but         | does               |              not | exist,   | re      |     |
| placed                                                                                         | by                                                                          | a                                              | fixed         | one                    |             |                    |             |                    |                  |          |         |     |
| {/usr/local/texlive/2016/texmf-dist/fonts/enc/dvips/cm-super/cm-super-t1.enc}</                  |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| usr/local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfbx1200.pfb></us                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| r/local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfbx2488.pfb></usr/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfcc1200.pfb></usr/lo                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| cal/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfit1000.pfb></usr/loca                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| l/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1095.pfb></usr/local/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1200.pfb></usr/local/te                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| xlive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1728.pfb></usr/local/texl                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| ive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm2488.pfb></usr/local/texliv                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| e/2016/texmf-dist/fonts/type1/public/cm-super/sfsx2488.pfb></usr/local/texlive/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| 2016/texmf-dist/fonts/type1/public/cm-super/sfti1200.pfb></usr/local/texlive/20                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| 16/texmf-dist/fonts/type1/public/cm-super/sftt1000.pfb></usr/local/texlive/2016                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| /texmf-dist/fonts/type1/public/cm-super/sftt1095.pfb></usr/local/texlive/2016/t                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| exmf-dist/fonts/type1/public/cm-super/sftt1200.pfb>                                            |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| Output                                                                                         | written                                                                     | on                                             | thesis.pdf    | (5                     | pages,      | 211699             | bytes).     |                    |                  |          |         |     |
...
| {/usr/local/texlive/2016/texmf-dist/fonts/enc/dvips/cm-super/cm-super-t1.enc}</                  |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| usr/local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfbx1200.pfb></us                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| r/local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfbx1440.pfb></usr/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| local/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfbx2488.pfb></usr/lo                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| cal/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfcc1200.pfb></usr/loca                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| l/texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfit1000.pfb></usr/local/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| texlive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1095.pfb></usr/local/te                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| xlive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1200.pfb></usr/local/texl                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| ive/2016/texmf-dist/fonts/type1/public/cm-super/sfrm1728.pfb></usr/local/texliv                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| e/2016/texmf-dist/fonts/type1/public/cm-super/sfrm2488.pfb></usr/local/texlive/                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| 2016/texmf-dist/fonts/type1/public/cm-super/sfsx1200.pfb></usr/local/texlive/20                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| 16/texmf-dist/fonts/type1/public/cm-super/sfsx2488.pfb></usr/local/texlive/2016                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| /texmf-dist/fonts/type1/public/cm-super/sfti1200.pfb></usr/local/texlive/2016/t                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| exmf-dist/fonts/type1/public/cm-super/sftt1000.pfb></usr/local/texlive/2016/tex                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| mf-dist/fonts/type1/public/cm-super/sftt1095.pfb></usr/local/texlive/2016/texmf                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| -dist/fonts/type1/public/cm-super/sftt1200.pfb>                                                |                                                                             |                                                |               |                        |             |                    |             |                    |                  |          |         |     |
| Output                                                                                         | written                                                                     | on                                             | thesis.pdf    | (4                     | pages,      | 222350             | bytes).     |                    |                  |          |         |     |
| Transcript                                                                                     | written                                                                     | on                                             | thesis.log.   |                        |             |                    |             |                    |                  |          |         |     |
