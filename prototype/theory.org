...
- [[#started-comment-normal-forms-][STARTED COMMENT Normal Forms 🚧]]
    - [[#packageformers-and-derived-__][PackageFormers and derived =_⊎_=]]
- [[#started-comment-meta-primitives-as-functions-][STARTED COMMENT Meta-Primitives as Functions 🚧]]
- [[#shallow-embedding-approach][Shallow Embedding Approach]]
  - [[#imports-1][Imports]]
  - [[#syntax-declarations-1][Syntax Declarations]]
...
* STARTED COMMENT Normal Forms 🚧                            :construction_site:
...
* STARTED COMMENT Meta-Primitives as Functions 🚧                 :construction_site:
