...
(unless (file-exists-p "~/.emacs.d/package-former.el")
  (shell-command (concat "curl "
    "https://raw.githubusercontent.com/alhassy/next-700-module-systems/master/package-former.el "
...
* Appending PackageFormer.el with the useful variationals :ignore:
  :PROPERTIES:
