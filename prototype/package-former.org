...
** COMMENT Primed Decoration and ~rename-mixfix~
   :PROPERTIES:
...
** COMMENT First-class PackageFormers
   :PROPERTIES:
...
** COMMENT Variationals with Arguments ---~map, rename, [co]decorated, subscriptedᵢ, renaming~
   :PROPERTIES:
...
** COMMENT Subpacakges with ~generated, sorts, signature~
   :PROPERTIES:
