# 𝒱-flipping broke!
# FIXME: RightUnitalActionR = LeftUnitalActionR flipping "_·_" :renaming "leftId to rightId" ⟴ record
:TODO:
...
(unless (file-exists-p "~/.emacs.d/agda-next-700-module-systems.el")
...
#+BEGIN_SRC agda
{-700
AbealianMonoidR = CommutativeMonoidR renaming "· to +"
-}
#+END_SRC
...
-- MeetSemiLatticeR = JoinSemiLatticeR flipping "_⊑_" :renaming "⊔ to ⊓; ⊔-lub to ⊓-glb"
-}
#+END_SRC
...
** COMMENT Namespacing                                        :experimenting:
   :PROPERTIES:
