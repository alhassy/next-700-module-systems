...
# | [[file:Testing.agda][Testing.agda] has up-to-date working examples.  |
...
can be useful.
* TODO Lisp requires                                               :relocate:noexport:
  :PROPERTIES:
...
** TODO Shallow Renaming with Agda's ~open ⋯ public ⋯ renaming ⋯~ :out_of_date:
   :PROPERTIES:
...
** TODO Subpacakges with ~generated, sorts, signature~ :out_of_date:
   :PROPERTIES:
...
** TODO Automatically deriving homomorphism definitions ♥‿♥ :out_of_date:
   :PROPERTIES:
...
* TODO Orphan content                                   :relocate:important:noexport:
  :PROPERTIES:
...
* TODO Appending PackageFormer.el with the useful variationals     :relocate:noexport:
  :PROPERTIES:
