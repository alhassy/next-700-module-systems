...
#+end_src
   ...
   \vspace{0.3em}
   \noindent
   We may alos want to have terms /over/ a particular variable set, and so declare:
   \vspace{0.3em}
     #+begin_src agda
...
* Next Steps
  ...
  + Extensible ::
     ...
     untyped metaprogramming is not for the faint of heart.
