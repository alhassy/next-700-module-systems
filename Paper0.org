...
#+begin_small
  ...
  essentially two levels of data ‘bundling’. This applies in particular to
  dependently-typed languages such as Agda, Coq, and Idris, where
  ...
  duplicate functionality. In our earlier example about graph datatypes,
  ...
  that is not only easily incorporated into Agda's  Emacs ecosystem, but is also unobtrusive to Agda users.
#+end_small
...
* COMMENT old  ---outline, 4 pages
  ...
  0. Introduction: Which perspective of semigroups does one select? Semigroup𝒾 from the thesis proposal;
...
* Introduction ---Selecting the ‘right’ perspective
  ...
  ‘field’ ---hidden as a component value--- has led to awkward formulations and
  the duplication of existing types for the sole purpose of different
  uses.
  \edchange{WK}{%
...
#+LATEX_HEADER: \newunicodechar{ℝ}{\ensuremath{\mathop{\mathbb{R}}}}
#+LATEX_HEADER: \newunicodechar{″}{''}
#+LATEX_HEADER: \newunicodechar{⨾}{\ensuremath{\mathop{\fatsemi}}}
#+LATEX_HEADER: \newunicodechar{Σ}{\ensuremath{\mathop{\Sigma}}}
#+LATEX_HEADER: \newunicodechar{∘}{\ensuremath{\mathop{\circ}}}
